...
qs:[
{q:"Verse 1.1 heaps several descriptions on Brahman. Which one does Bhattathiri place first, as the poem's opening word?",o:["Nityamukta — eternally liberated","Nirbhāsyamāna — illumined by scripture","Sāndrānanda — concentrated bliss","Urupuruṣārtha — the supreme human goal"],a:2,exp:"The poem begins 'sāndrānandāvabodhātmakam' — of the nature of dense, concentrated bliss and pure awareness. Bhattathiri opens not with a name or an invocation but with a definition of the Absolute."},
{q:"From which two limits does the opening verse declare Brahman to be free?",o:["Birth and death","Name and form","Merit and sin","Time and space"],a:3,exp:"'Kāla-deśāvadhibhyāṁ nirmuktam' — released from the boundaries of both time and place. The whole force of the verse is that this unbounded Reality is nonetheless standing in one particular temple."},
{q:"What is the astonishing claim the first verse makes about Guruvāyūr?",o:["That Brahmā himself installed the image","That Brahman shines there in visible form","That the temple predates the Vedas themselves","That no impure person may cross the threshold"],a:1,exp:"'Tat tāvad bhāti sākṣād gurupavanapure' — that very Brahman shines there in person. Bhattathiri ends with 'hanta bhāgyaṁ janānām' — what great fortune of the people! — and that wonder sets the tone for all hundred dasakams."}
]},
